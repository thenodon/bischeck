 ...
 */
public class AverageMadSetThreshold extends PostfixMathCommand {
     ...
     * Constructor.
     */
    public AverageMadSetThreshold() {
        // Use a variable number of arguments
        numberOfParameters = -1;
        this.supportNull = Util.getSupportNull();
    }

    public AverageMadSetThreshold(boolean supportNull) {
        // Use a variable number of arguments
        numberOfParameters = -1;
    ...
    public void run(Stack stack) throws ParseException {
        ...
        while (i < (curNumberOfParameters - 1)) {
            param = stack.pop();
