...
/**
 * The interface describe all methods need to create a Service compatible class
 * that can be instantiated by ServiceFactory class. The implemented class must
 * have a constructor with a parameter of String that is the service name. The
 * service name is the identification of the Service and must be unique in scope
 * of the host its configured for. <br>
 ...
 * class {@link ServiceAbstract} class.
 * 
 * 
 */
public interface Service {
     ...
     * to enable the selection of custom Service classes. This will change in
     * the future by implementing a configuration based definition of Service
     * classes and corresponding url schema.
     * 
     * @param connectionUrl
     *            e.g. jdbc://...
     */
    ...
    /**
     * Set the List of execution schedules, according to quartz crontrigger
     * format
     * 
     * @param schedulelist
     */
     ...
     *            Class name for the driver class
     */
     ...
     *             if the opening of connection fail
     */
     ...
     * 
     * @throws ServiceException
     *             if the closing of connection fails
     */
    ...
    /**
     * The method is called by the framework to add all service items related to
     * the specific instance of the Service.
     * 
     * @param serviceItem
     *            The ServiceItem object to add
     */
     ...
     * 
     * @param sendServiceData
     *            true to send and false not to send.
     */
    void setSendServiceData(Boolean sendServiceData);

    /**
     * Get the alias for the Service
     * 
     * @return the alias
     */
    String getAlias();
