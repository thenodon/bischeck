...
public class UtilTest {
    ...
    @Test (groups = { "Util" })
    public void isNullIn() {
    	Assert.assertEquals(Util.hasStringNull("null"), true);
    	Assert.assertEquals(Util.hasStringNull("null,null,null,null,null,null"), true);
    	Assert.assertEquals(Util.hasStringNull("15,14,13,12,null,10,9"), true);
    	Assert.assertEquals(Util.hasStringNull("15,14,13,12,10,9"), false);
    	Assert.assertEquals(Util.hasStringNull("null,14,13,12,10,9"), true);
    }
